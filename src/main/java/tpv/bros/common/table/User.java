...
public class User extends Entity {
	...
	@Column(name = UserMapper.COLUMN___FIRST_NAME, label = "First name", type = ColumnType.TEXT, mandatory = true)
	...
	@Column(name = UserMapper.COLUMN___MIDDLE_NAME, label = "Middle name", type = ColumnType.TEXT)
	...
	@Column(name = UserMapper.COLUMN___LAST_NAME, label = "Last name", type = ColumnType.TEXT, mandatory = true)
	...
	@Column(name = UserMapper.COLUMN___PHONE_NUMBER, label = "Phone number", type = ColumnType.TEXT, mandatory = true)
	...
	@Column(name = UserMapper.COLUMN___ZALO_NUMBER, label = "Zalo number", type = ColumnType.TEXT)
